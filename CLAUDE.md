...
## Recent
2026-09-26 — Client-side min password 8 — Done: shared MIN_PASSWORD_LENGTH=8 in signup (had none) + ResetPassword (was 6), message updated in 10 languages; E2E: 7 chars refused, nothing sent to Auth. Server still accepts 7 chars (dashboard setting not effective) and leaked-password protection needs Pro. See docs/ACTIVITY_LOG.md.
