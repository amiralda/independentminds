...
const sectionsEN = [
  ...
  { title: "Eligibility", content: ["You must be 18 years of age or older to register as a parent on this platform. By registering, you confirm that you are the parent or legal guardian of unknown students you manage."] },
  { title: "Account Responsibilities", content: ["You are responsible for maintaining the confidentiality of your account credentials. You are responsible for all activities that occur under your account. Notify us immediately at legal@independentmindsedu.org if you suspect unauthorized access."] },
  { title: "Acceptable Use", content: ["Independent Minds EDU is designed exclusively for private family educational use — managing homeschool schedules, tracking student progress, and facilitating learning.", "Independent Minds EDU is designed for private family use. It is not a school records system under FERPA. If you represent an institution receiving federal funding, contact legal@independentmindsedu.org before use.", "You agree not to use the platform for unknown unlawful purpose, to upload harmful content, or to attempt to gain unauthorized access to other users' data."] },
  { title: "Student Data", content: ["Parents are solely responsible for the accuracy of student data entered. Parents may add, edit, or delete student records at unknown time. All student data is subject to our Privacy Policy."] },
  ...
  { title: "Intellectual Property", content: ["Independent Minds EDU, including all code, design, content, and branding, is owned by KòdLabo. You may not copy, modify, distribute, or create derivative works from the platform without prior written consent."] },
  { title: "Limitation of Liability", content: ["Independent Minds EDU is provided \"as is\" without warranties of unknown kind. We are not liable for unknown indirect, incidental, or consequential damages arising from your use of the platform. Our total liability is limited to the amount you have paid for the service, if unknown."] },
  { title: "Termination", content: ["We reserve the right to suspend or terminate accounts that violate these terms. You may delete your account at unknown time through the platform settings. Upon deletion, all associated data will be permanently removed."] },
  ...
  { title: "Contact", content: ["For legal inquiries: legal@independentmindsedu.org", "Website: independentmindsedu.org"] },
];
...
const sectionsHT = [
  ...
  { title: "Responsablite Kont", content: ["Ou responsab pou kenbe konfidansyalite enfòmasyon koneksyon kont ou. Ou responsab pou tout aktivite ki fèt anba kont ou. Notifye nou imedyatman nan legal@independentmindsedu.org si ou sispèk aksè san otorizasyon."] },
  { title: "Itilizasyon Akseptab", content: ["Independent Minds EDU fèt eksklizivman pou itilizasyon edikasyon familyal prive — jere orè lekòl kay, swiv pwogrè elèv, epi fasilite aprantisaj.", "Independent Minds EDU fèt pou itilizasyon familyal prive. Li pa yon sistèm dosye lekòl anba FERPA. Si ou reprezante yon enstitisyon ki resevwa finansman federal, kontakte legal@independentmindsedu.org anvan itilizasyon.", "Ou dakò pou pa itilize platfòm nan pou okenn objektif ilegal, pou telechaje kontni danjere, oswa pou eseye jwenn aksè san otorizasyon nan done lòt itilizatè."] },
  ...
  { title: "Pwopriyete Entelektyèl", content: ["Independent Minds EDU, ki gen ladan tout kòd, konsepsyon, kontni, ak mak, se pwopriyete KòdLabo. Ou pa ka kopye, modifye, distribye, oswa kreye travay derive soti nan platfòm nan san konsantman ekri alavans."] },
  ...
  { title: "Kontak", content: ["Pou demann legal: legal@independentmindsedu.org", "Sit wèb: independentmindsedu.org"] },
];
