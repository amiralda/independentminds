...
const sectionsEN = [
  ...
  { title: "Account Responsibilities", content: ["You are responsible for maintaining the confidentiality of your account credentials. You are responsible for all activities that occur under your account. Notify us immediately at legal@independentminds.org if you suspect unauthorized access."] },
  { title: "Acceptable Use", content: ["Independent Minds EDU is designed exclusively for private family educational use — managing homeschool schedules, tracking student progress, and facilitating learning.", "Independent Minds EDU is designed for private family use. It is not a school records system under FERPA. If you represent an institution receiving federal funding, contact legal@independentminds.org before use.", "You agree not to use the platform for unknown unlawful purpose, to upload harmful content, or to attempt to gain unauthorized access to other users' data."] },
  ...
  { title: "Contact", content: ["For legal inquiries: legal@independentminds.org", "Website: independentminds.org"] },
];
...
const sectionsHT = [
  ...
  { title: "Responsablite Kont", content: ["Ou responsab pou kenbe konfidansyalite enfòmasyon koneksyon kont ou. Ou responsab pou tout aktivite ki fèt anba kont ou. Notifye nou imedyatman nan legal@independentminds.org si ou sispèk aksè san otorizasyon."] },
  { title: "Itilizasyon Akseptab", content: ["Independent Minds EDU fèt eksklizivman pou itilizasyon edikasyon familyal prive — jere orè lekòl kay, swiv pwogrè elèv, epi fasilite aprantisaj.", "Independent Minds EDU fèt pou itilizasyon familyal prive. Li pa yon sistèm dosye lekòl anba FERPA. Si ou reprezante yon enstitisyon ki resevwa finansman federal, kontakte legal@independentminds.org anvan itilizasyon.", "Ou dakò pou pa itilize platfòm nan pou okenn objektif ilegal, pou telechaje kontni danjere, oswa pou eseye jwenn aksè san otorizasyon nan done lòt itilizatè."] },
  ...
  { title: "Kontak", content: ["Pou demann legal: legal@independentminds.org", "Sit wèb: independentminds.org"] },
];
