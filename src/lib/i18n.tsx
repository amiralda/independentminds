...
const translations: Translations = {
  ...
  "beta.mission_banner.earn_points": { EN: "Complete it to earn {{points}} pts.", HT: "Fini li pou w ranmase {{points}} pwen.", FR: "Complétez pour gagner {{points}} pts.", ES: "Complétalo para ganar {{points}} pts.", PT: "Complete para ganhar {{points}} pts.", AR: "أكمله لتكسب {{points}} نقطة.", ZH: "完成它可获得{{points}}分。", DE: "Erledigen Sie es, um {{points}} Pkt. zu verdienen.", JA: "完了すると{{points}}ポイント獲得。", RU: "Выполните, чтобы заработать {{points}} очков." },
