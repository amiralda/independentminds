...
const translations: Translations = {
  ...
  "role.educator": { EN: "Educator", HT: "Edikatè", FR: "Éducateur", ES: "Educador", PT: "Educador", AR: "معلم", ZH: "教育者", DE: "Erzieher", JA: "教育者", RU: "Преподаватель" },
  "role.switchRole": { EN: "Switch Role", HT: "Chanje Wòl", FR: "Changer de rôle", ES: "Cambiar rol", PT: "Trocar papel", AR: "تبديل الدور", ZH: "切换角色", DE: "Rolle wechseln", JA: "役割を切り替え", RU: "Сменить роль" },
  "educators.title": { EN: "Educators", HT: "Edikatè", FR: "Éducateurs", ES: "Educadores", PT: "Educadores", AR: "المعلمين", ZH: "教育者", DE: "Erzieher", JA: "教育者", RU: "Преподаватели" },
  "educators.viewCheckins": { EN: "View Check-ins", HT: "Wè Tcheke", FR: "Voir les pointages", ES: "Ver registros", PT: "Ver check-ins", AR: "عرض التسجيلات", ZH: "查看签到", DE: "Check-ins ansehen", JA: "チェックインを見る", RU: "Просмотр отметок" },
  "educators.viewReports": { EN: "View Reports", HT: "Wè Rapò", FR: "Voir les rapports", ES: "Ver informes", PT: "Ver relatórios", AR: "عرض التقارير", ZH: "查看报告", DE: "Berichte ansehen", JA: "レポートを見る", RU: "Просмотр отчётов" },
  "educators.editSchedule": { EN: "Edit Schedule", HT: "Modifye Orè", FR: "Modifier l'horaire", ES: "Editar horario", PT: "Editar agenda", AR: "تعديل الجدول", ZH: "编辑日程", DE: "Zeitplan bearbeiten", JA: "スケジュール編集", RU: "Редактировать расписание" },
  "educators.useAiTutor": { EN: "Use AI Tutor", HT: "Itilize Titè IA", FR: "Utiliser le tuteur IA", ES: "Usar tutor IA", PT: "Usar tutor IA", AR: "استخدام المعلم الذكي", ZH: "使用AI导师", DE: "KI-Tutor nutzen", JA: "AIチューターを使う", RU: "Использовать ИИ-репетитора" },
  "educators.receiveSos": { EN: "Receive SOS", HT: "Resevwa SOS", FR: "Recevoir SOS", ES: "Recibir SOS", PT: "Receber SOS", AR: "استلام SOS", ZH: "接收SOS", DE: "SOS empfangen", JA: "SOSを受け取る", RU: "Получать SOS" },
  "educators.invitePlaceholder": { EN: "Educator's email address", HT: "Adrès imèl edikatè a", FR: "Adresse email de l'éducateur", ES: "Correo del educador", PT: "Email do educador", AR: "بريد المعلم", ZH: "教育者邮箱", DE: "E-Mail des Erziehers", JA: "教育者のメールアドレス", RU: "Email преподавателя" },
  "educators.sendInvite": { EN: "Invite Educator", HT: "Envite Edikatè", FR: "Inviter l'éducateur", ES: "Invitar educador", PT: "Convidar educador", AR: "دعوة المعلم", ZH: "邀请教育者", DE: "Erzieher einladen", JA: "教育者を招待", RU: "Пригласить преподавателя" },
  "educators.noEducators": { EN: "No educators assigned yet", HT: "Pa gen edikatè ankò", FR: "Aucun éducateur assigné", ES: "Sin educadores asignados", PT: "Nenhum educador atribuído", AR: "لا معلمين معينين", ZH: "尚未分配教育者", DE: "Noch keine Erzieher zugewiesen", JA: "教育者未割り当て", RU: "Преподаватели не назначены" },
  "educators.educator": { EN: "Educator", HT: "Edikatè", FR: "Éducateur", ES: "Educador", PT: "Educador", AR: "معلم", ZH: "教育者", DE: "Erzieher", JA: "教育者", RU: "Преподаватель" },
  "educators.permissionsLabel": { EN: "Educator Permissions", HT: "Pèmisyon Edikatè", FR: "Permissions de l'éducateur", ES: "Permisos del educador", PT: "Permissões do educador", AR: "صلاحيات المعلم", ZH: "教育者权限", DE: "Erzieher-Berechtigungen", JA: "教育者の権限", RU: "Права преподавателя" },
  "educators.noStudentsAssigned": { EN: "No Students Assigned", HT: "Pa Gen Elèv", FR: "Aucun élève assigné", ES: "Sin estudiantes asignados", PT: "Nenhum aluno atribuído", AR: "لا طلاب معينين", ZH: "未分配学生", DE: "Keine Schüler zugewiesen", JA: "生徒未割り当て", RU: "Ученики не назначены" },
  "educators.waitForInvite": { EN: "You'll see students here once a parent assigns you.", HT: "Wap wè elèv la isit la lè yon paran ba ou aksè.", FR: "Les élèves apparaîtront ici quand un parent vous assignera.", ES: "Verás estudiantes aquí cuando un padre te asigne.", PT: "Você verá alunos aqui quando um pai te atribuir.", AR: "ستظهر الطلاب هنا عندما يعيّنك أحد الوالدين", ZH: "家长分配后您将在此看到学生", DE: "Schüler erscheinen hier, wenn ein Elternteil Sie zuweist.", JA: "保護者が割り当てると生徒が表示されます", RU: "Ученики появятся здесь, когда родитель назначит вас" },
