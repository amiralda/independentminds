...
const translations: Translations = {
  ...
  "schedule.noBlocks": { EN: "No blocks scheduled for today", HT: "Pa gen blòk pou jodi a", FR: "Aucun bloc prévu aujourd'hui", ES: "No hay bloques para hoy", PT: "Nenhum bloco agendado para hoje", AR: "لا كتل مجدولة لليوم", ZH: "今天没有安排区块", DE: "Keine Blöcke für heute geplant", JA: "今日のブロックはありません", RU: "На сегодня блоков нет" },
  ...
  "dadpanel.manageCoGuardians": { EN: "Manage Co-Guardians", HT: "Jere Ko-gadyen", FR: "Gérer les co-tuteurs", ES: "Gestionar co-tutores", PT: "Gerenciar co-responsáveis", AR: "إدارة الأولياء المشاركين", ZH: "管理共同监护人", DE: "Mit-Erziehungsberechtigte verwalten", JA: "共同保護者を管理", RU: "Управление со-опекунами" },
  "dadpanel.invitesAndPermissions": { EN: "Invites & permissions", HT: "Envite ak pèmisyon", FR: "Invitations et permissions", ES: "Invitaciones y permisos", PT: "Convites e permissões", AR: "الدعوات والأذونات", ZH: "邀请与权限", DE: "Einladungen & Berechtigungen", JA: "招待と権限", RU: "Приглашения и разрешения" },
  "dadpanel.students": { EN: "Students", HT: "Elèv yo", FR: "Élèves", ES: "Estudiantes", PT: "Alunos", AR: "الطلاب", ZH: "学生", DE: "Schüler", JA: "生徒", RU: "Ученики" },
  ...
  "dadpanel.selectStudent": { EN: "Tap ☰ to choose a student", HT: "Tape ☰ pou chwazi yon elèv", FR: "Appuyez sur ☰ pour choisir un élève", ES: "Toca ☰ para elegir un estudiante", PT: "Toque ☰ para escolher um aluno", AR: "اضغط ☰ لاختيار طالب", ZH: "点击 ☰ 选择学生", DE: "Tippen Sie ☰ um einen Schüler zu wählen", JA: "☰ をタップして生徒を選択", RU: "Нажмите ☰ чтобы выбрать ученика" },
  ...
  "rewards.wallet": { EN: "Wallet", HT: "Pòtfèy", FR: "Portefeuille", ES: "Billetera", PT: "Carteira", AR: "المحفظة", ZH: "钱包", DE: "Geldbörse", JA: "ウォレット", RU: "Кошелёк" },
  ...
  "rewards.notEnough": { EN: "Not enough points!", HT: "Pa gen ase pwen!", FR: "Pas assez de points !", ES: "¡No hay suficientes puntos!", PT: "Pontos insuficientes!", AR: "نقاط غير كافية!", ZH: "积分不足！", DE: "Nicht genug Punkte!", JA: "ポイントが不足しています！", RU: "Недостаточно очков!" },
  "rewards.redeem": { EN: "Redeem", HT: "Reklame", FR: "Échanger", ES: "Canjear", PT: "Resgatar", AR: "استرداد", ZH: "兑换", DE: "Einlösen", JA: "交換", RU: "Обменять" },
  "rewards.needMore": { EN: "Need more", HT: "Bezwen plis", FR: "Besoin de plus", ES: "Necesitas más", PT: "Precisa de mais", AR: "تحتاج المزيد", ZH: "需要更多", DE: "Mehr benötigt", JA: "もっと必要", RU: "Нужно больше" },
  ...
  "rewards.noRedemptions": { EN: "No redemptions yet", HT: "Pa gen reklame ankò", FR: "Aucun échange", ES: "Sin canjes aún", PT: "Nenhum resgate", AR: "لا استردادات بعد", ZH: "还没有兑换", DE: "Noch keine Einlösungen", JA: "まだ交換がありません", RU: "Обменов пока нет" },
  ...
  "rewards.sent": { EN: "Sent", HT: "Voye", FR: "Envoyé", ES: "Enviado", PT: "Enviado", AR: "مرسل", ZH: "已发送", DE: "Gesendet", JA: "送信済み", RU: "Отправлено" },
  "rewards.suggest": { EN: "Suggest", HT: "Sijere", FR: "Suggérer", ES: "Sugerir", PT: "Sugerir", AR: "اقتراح", ZH: "建议", DE: "Vorschlagen", JA: "提案", RU: "Предложить" },
  ...
  // Challenges
  "challenges.title": { EN: "Challenges", HT: "Defi", FR: "Défis", ES: "Desafíos", PT: "Desafios", AR: "تحديات", ZH: "挑战", DE: "Herausforderungen", JA: "チャレンジ", RU: "Вызовы" },
  "challenges.new": { EN: "New", HT: "Nouvo", FR: "Nouveau", ES: "Nuevo", PT: "Novo", AR: "جديد", ZH: "新建", DE: "Neu", JA: "新規", RU: "Новый" },
  "challenges.noActive": { EN: "No active challenges", HT: "Pa gen defi aktif", FR: "Aucun défi actif", ES: "Sin desafíos activos", PT: "Sem desafios ativos", AR: "لا تحديات نشطة", ZH: "没有活跃的挑战", DE: "Keine aktiven Herausforderungen", JA: "アクティブなチャレンジなし", RU: "Нет активных вызовов" },
  ...
  "challenges.created": { EN: "Challenge created!", HT: "Defi kreye!", FR: "Défi créé !", ES: "¡Desafío creado!", PT: "Desafio criado!", AR: "تم إنشاء التحدي!", ZH: "挑战已创建！", DE: "Herausforderung erstellt!", JA: "チャレンジが作成されました！", RU: "Вызов создан!" },
  "challenges.newChallenge": { EN: "New Challenge", HT: "Nouvo Defi", FR: "Nouveau défi", ES: "Nuevo desafío", PT: "Novo desafio", AR: "تحدي جديد", ZH: "新挑战", DE: "Neue Herausforderung", JA: "新しいチャレンジ", RU: "Новый вызов" },
  ...
  "feedback.rate": { EN: "Rate", HT: "Evalye", FR: "Évaluer", ES: "Calificar", PT: "Avaliar", AR: "قيّم", ZH: "评分", DE: "Bewerten", JA: "評価", RU: "Оценить" },
  ...
  "feedback.howIsExperience": { EN: "How is your experience today?", HT: "Kijan eksperyans ou jodi a?", FR: "Comment est votre expérience aujourd'hui ?", ES: "¿Cómo es tu experiencia hoy?", PT: "Como está sua experiência hoje?", AR: "كيف تجربتك اليوم؟", ZH: "今天的体验怎么样？", DE: "Wie ist Ihre Erfahrung heute?", JA: "今日の使用感はいかがですか？", RU: "Как ваш опыт сегодня?" },
  "feedback.anyComments": { EN: "Any comments? (optional)", HT: "Kòmantè? (opsyonèl)", FR: "Des commentaires ? (optionnel)", ES: "¿Comentarios? (opcional)", PT: "Comentários? (opcional)", AR: "أي تعليقات؟ (اختياري)", ZH: "有什么意见？（可选）", DE: "Kommentare? (optional)", JA: "コメント？（任意）", RU: "Комментарии? (необязательно)" },
  "feedback.whatWentWrong": { EN: "What went wrong?", HT: "Kisa ki te mal pase?", FR: "Qu'est-ce qui n'a pas fonctionné ?", ES: "¿Qué salió mal?", PT: "O que deu errado?", AR: "ما الذي حدث؟", ZH: "出了什么问题？", DE: "Was ist schiefgelaufen?", JA: "何が問題でしたか？", RU: "Что пошло не так?" },
  "feedback.describeIssue": { EN: "Describe the issue...", HT: "Dekri pwoblèm nan...", FR: "Décrivez le problème...", ES: "Describe el problema...", PT: "Descreva o problema...", AR: "صف المشكلة...", ZH: "描述问题...", DE: "Beschreiben Sie das Problem...", JA: "問題を説明してください...", RU: "Опишите проблему..." },
  ...
  "feedback.reportProblem": { EN: "Report Problem", HT: "Rapòte Pwoblèm", FR: "Signaler un problème", ES: "Reportar problema", PT: "Reportar problema", AR: "الإبلاغ عن مشكلة", ZH: "报告问题", DE: "Problem melden", JA: "問題を報告", RU: "Сообщить о проблеме" },
  ...
  "feedback.yourSuggestion": { EN: "Your suggestion...", HT: "Sijesyon ou...", FR: "Votre suggestion...", ES: "Tu sugerencia...", PT: "Sua sugestão...", AR: "اقتراحك...", ZH: "您的建议...", DE: "Ihr Vorschlag...", JA: "あなたの提案...", RU: "Ваше предложение..." },
  ...
  "feedback.giveFeedback": { EN: "Give feedback", HT: "Bay fidbak", FR: "Donner un retour", ES: "Dar feedback", PT: "Dar feedback", AR: "إعطاء ملاحظات", ZH: "提供反馈", DE: "Feedback geben", JA: "フィードバックする", RU: "Оставить отзыв" },
  "feedback.closeFeedback": { EN: "Close feedback", HT: "Fèmen fidbak", FR: "Fermer le retour", ES: "Cerrar feedback", PT: "Fechar feedback", AR: "إغلاق الملاحظات", ZH: "关闭反馈", DE: "Feedback schließen", JA: "フィードバックを閉じる", RU: "Закрыть отзыв" },
